...
// pulling the array from the DATA (JSON object) that contains the data we care about
// looking in the DATA object we see it has a features array containing what we need
...
const inData = {
  datasets: [{
    ...
    data: myData,
    parsing: {
      xAxisKey: "properties.date",
      yAxisKey: "properties.rain__pluie"
    },
